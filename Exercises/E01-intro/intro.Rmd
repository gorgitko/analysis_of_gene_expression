...
**The important thing is that `tmux` sessions are persistent until you restart a server.**
...
You can create a symlink: `ln -s /data/persistent/<user> /home/<user>/persistent`
...
create your personal directory `/data/persistent/<user>/AGE2020/Exercises` in which you will
...
```{bash, eval = FALSE}
cp -r /data/shared/AGE2020/Exercises/{age_library.R,stylesheet.css,E01-intro} /data/persistent/<user>/AGE2020/Exercises
```
