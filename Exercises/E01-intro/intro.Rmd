...
!["In sessions, you create windows which can be split to panes.](`r here("E01-intro/images/tmux.png")`)
...
rmarkdown::render(here("E01-intro/intro.Rmd"), output_file = here("E01-intro/intro.html"), envir = new.env())
```
