...
between samples, fold-change: $FC = 2^{\Delta C_{P,cnt} - \Delta C_{P,trt}}$.
We usually report $FC$ in log2 scale: $LFC = \Delta C_{P,cnt} - \Delta C_{P,trt} = log_2(FC)$](images/qpcr_curves.png)
