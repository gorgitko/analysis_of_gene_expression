...
author:
  - Michal Kolar jiri.novotny@img.cas.cz
...
```{bash, eval = FALSE}
cp -r ~/shared/AGE2021/Exercises/E05-multiple_testing_issue ~/AGE2021/Exercises
```
...
save.image(here("E05-multiple_testing_issue/multiple_testing_issue.RData"))
...
rmarkdown::render(
  ...
  output_file = here("E05-multiple_testing_issue/multiple_testing_issue.html"), envir = new.env()
)
```
