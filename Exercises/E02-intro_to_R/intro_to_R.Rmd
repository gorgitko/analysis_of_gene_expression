...
It is quite long, but some sections are really necessary to go through, as we will utilize them in following exercises and assignments:
...
So try to avoid for-loops if possible, because:

**For-loops have side effects**

- Leaving iterating variable in environment. From the example above, the variable `i` still has value `r i`.
