...
save.image(here("E02-intro_to_R/intro_to_R.RData"))
...
rmarkdown::render(here("E02-intro_to_R/intro_to_R.Rmd"), output_file = here("E02-intro_to_R/intro_to_R.html"), envir = new.env())
```
